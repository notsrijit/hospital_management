		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="patient_details.php" class="list-group-item list-group-item-action active">Patient Details</a>
					<a href="payment_update.php" class="list-group-item list-group-item-action">Payments and Checkout</a>
				</div>
			</div>
			<br>
			<div class="col-md-9">
				<div class="card">
					<div class="card-body" style="background-color: #007BFF; color: #FFFFFF;">
						<div class="row">
							<div class="col-md-1"><a href="admin-panel.php" class="btn btn-light"><font color="#007BFF"><strong>Go Back</strong></font></a> </div>
							<div class="col-md-4"><center><h3>Patient Details</h3></center></div>
							<div class="col-md-7">
								<form class="form-group" action="patient_search.php" method="post">
									<div class="row">
										<div class="col-md-9"><input type="text" name="search" class="form-control" placeholder="enter contact"></div>
										<div class="col-md-3"><input type="submit" name="patient_search_submit" class="btn btn-light" value="Search"></div>
									</div>
								</form>
							</div>
						</div>
