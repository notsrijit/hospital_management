		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					<a href="admin-panel.php" class="list-group-item list-group-item-action active">Add Patient</a>
				...
				<div class="card">
					...
					<div class="card-body">
						<form class="form-group" action="func.php" method="post">
							...
							<input type="submit" class="btn btn-primary" name="pat_submit" value="Confirm Admission"><br>
						</form>
					</div>
