	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item active">
	        <a class="nav-link" href="admin-panel-staff.php"><i class="fas fa-user-plus" aria-hidden="true"></i>  Staff <span class="sr-only">(current)</span></a>
	      </li>
	    </ul>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					<a href="admin-panel-staff.php" class="list-group-item list-group-item-action active">Add Staff</a>
					<a href="staff_details.php" class="list-group-item list-group-item-action">Staff Details</a>
				</div>
			</div>
			<div class="col-md-9">
				<div class="card">
					...
					<div class="card-body">
						<form class="form-group" action="func.php" method="post">
							...
							<input type="submit" class="btn btn-primary" name="staff_submit" value="Confirm Enrollment"><br>
						</form>
					</div>
