		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					<a href="admin-panel-doctor.php" class="list-group-item list-group-item-action">Add Doctor</a>
					<a href="doctor_details.php" class="list-group-item list-group-item-action active">Doctor Details</a>
				</div>
			</div>
			<br>
			<div class="col-md-9">
				<div class="card">
					<div class="card-body" style="background-color: #007BFF; color: #FFFFFF;">
						<div class="row">
							<div class="col-md-1"><a href="admin-panel-doctor.php" class="btn btn-light"><font color="#007BFF"><strong>Go Back</strong></font></a> </div>
							<div class="col-md-4"><center><h3>Doctor Details</h3></center></div>
							<div class="col-md-7">
								<form class="form-group" action="doctor_search.php" method="post">
									<div class="row">
										...
										<div class="col-md-3"><input type="submit" name="doctor_search_submit" class="btn btn-light" value="Search"></div>
									</div>
								</form>
							</div>
						</div>
